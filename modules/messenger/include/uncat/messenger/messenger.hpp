...
namespace uncat
{
    ...
    private:
        template<typename T>
        auto add_handler_unsafe(name_t const & name, handler_t<T> const & handler) -> void;
        
        template<typename T>
        auto remove_handler_unsafe(name_t const & name) -> void;

        template<typename T>
        auto send_unsafe(T const & event) -> void;
    ...
    template<types::oneof<E...> T> inline
    auto messenger<K, E...>::
    add_handler(name_t name, handler_t<T> func) -> messenger &
    {
    ...
    template<types::oneof<E...> T> inline
    auto messenger<K, E...>::
    remove_handler(name_t name) -> messenger &
    {
    ...
    template<typename T>
    requires types::oneof<std::remove_cvref_t<T>, E...>
    inline auto messenger<K, E...>::
    send(T && event) -> messenger &
    {
    ...
    template<typename K, typename ... E> inline
    auto messenger<K, E...>::
    wait() -> void
    {
    ...
    template<typename K, typename ... E>
    template<typename T> inline auto messenger<K, E...>::
    add_handler_unsafe(name_t const & name, handler_t<T> const & func) -> void
    {
    ...
    template<typename K, typename ... E>
    template<typename T> inline auto messenger<K, E...>::
    remove_handler_unsafe(name_t const & name) -> void
    {
        auto & group = std::get<group_t<T>>(gorups);
    ...
    template<typename K, typename ... E>
    template<typename T> inline auto messenger<K, E...>::
    send_unsafe(T const & event) -> void
    {
