...
#include <orz/detail/list.hpp>

TEST_CASE("find_if", "[list]")
{
    using orz::detail::pack;
    using orz::detail::same_to_type;
    using orz::detail::find_if_base;
...
{
    using orz::detail::pack;
    using orz::detail::is_subset_base;
